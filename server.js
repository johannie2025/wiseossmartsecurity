 ...
 * Compatible avec wise_os_v31.sql (dernière version)
 */
...
async function sendWA(tenantId, phone, text) {
  let sd = sessions.get(tenantId || 1); // fallback tenant 1
...
async function startServer() {
  ...
  app.listen(PORT, async () => {
    ...
    const centralTenant = 1; // Tenant par défaut
